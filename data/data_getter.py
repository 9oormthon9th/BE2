...
def get_info(courseNum: str):
    """Returns data from olle.csv
    :rtype: DataFrame
    """
    result = olleDf[olleDf["올레길 코스 번호"] == (courseNum + "코스")]
    result = result.iloc[0]
    return result


def get_description(courseNum: str):
    """Returns description from description.csv
    :rtype: str
    """
    description = descriptionDf[descriptionDf["course"] == (courseNum)]
